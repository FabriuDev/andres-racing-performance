...
const kartServices = [
  {
    ...
    imgFallbacks: ['/img/karting/karting-alineacion.webp'],
  ...
  {
    img: '/img/karting/karting-ajuste-eje.webp',
    imgFallbacks: [],
  ...
  {
    img: '/img/karting/karting-mecanica.webp',
    imgFallbacks: [],
  ...
  {
    img: '/img/karting/karting-preparacion.webp',
    imgFallbacks: [],
  ...
  {
    img: '/img/karting/karting-bandera.webp',
    imgFallbacks: [],
  ...
  {
    img: '/img/karting/karting-setup-tablet.webp',
    imgFallbacks: [],
...
const kartPhotos = [
  { src: '/img/karting/karting-taller.webp',         alt: 'Kart ARP en taller — Pinamar' },
  { src: '/img/karting/karting-revision.webp',       alt: 'Revisión delantera de karting — ARP' },
  { src: '/img/karting/karting-motor-premium.webp',  alt: 'Motor karting premium — Andrés Racing Performance' },
  { src: '/img/karting/karting-motor.webp',          alt: 'Trabajo en motor de karting — ARP' },
  { src: '/img/karting/karting-ajuste-eje.webp',     alt: 'Ajuste de eje karting — ARP Pinamar' },
  { src: '/img/karting/karting-transmision.webp',    alt: 'Transmisión de karting — Andrés Racing Performance' },
  { src: '/img/karting/karting-cadena.webp',         alt: 'Cadena y piñón karting — ARP Pinamar' },
  { src: '/img/karting/karting-setup-tablet.webp',   alt: 'Setup técnico karting con tablet — ARP' },
  { src: '/img/karting/karting-bandera.webp',        alt: 'Andrés trabajando en karting — Pinamar Argentina' },
]
      ...
      <div className="wrap">
        ...
        <div ref={featureRef} className="karting-feature reveal">
          <ImageCrossfade
            ...
            interval={6000}
            images={[
              { src: '/img/karting/karting-hero.webp',          alt: 'Taller karting ARP — Pinamar, Buenos Aires',              pos: 'center center' },
              { src: '/img/karting/karting-motor-premium.webp', alt: 'Mecánica de motor karting — Andrés Racing Performance',   pos: 'center center' },
              { src: '/img/karting/karting-setup-tablet.webp',  alt: 'Setup técnico karting con datos — ARP Pinamar',           pos: 'center center' },
            ]}
          />
