...
const services = [
  {
    images: [
      { src: '/img/svc/diagnostico-tablet-capo.webp',    alt: 'Diagnóstico con escáner — Andrés Racing Performance · Pinamar', pos: 'center center' },
      { src: '/img/svc/mecanica-taller-piezas.webp',     alt: 'Taller mecánica ARP — Pinamar', pos: 'center center' },
      { src: '/img/svc/diagnostico-tablet-interior.webp',alt: 'Diagnóstico electrónico ARP — Pinamar', pos: 'center center' },
    ],
    Icon: WrenchIcon,
  ...
  {
    images: [
      { src: '/img/svc/dyno-golf-banco.webp',    alt: 'Banco Dynojet VW Golf — Andrés Racing Performance · Pinamar', pos: 'center center' },
      { src: '/img/svc/dyno-peugeot-banco.webp', alt: 'Banco Dynojet Peugeot — ARP Pinamar', pos: 'center center' },
      { src: '/img/dyno-banco-curva.webp',        alt: 'Curva potencia banco Dynojet — ARP', pos: 'center center' },
    ],
    featured: true,
    Icon: ActivityIcon,
    title: 'Banco Dynojet',
  ...
  {
    images: [
      { src: '/img/karting/karting-motor-premium.webp', alt: 'Mecánica karting — Andrés Racing Performance · Pinamar', pos: 'center center' },
      { src: '/img/karting/karting-revision.webp',      alt: 'Revisión karting ARP — Pinamar', pos: 'center center' },
      { src: '/img/karting/karting-setup-tablet.webp',  alt: 'Setup técnico karting — ARP Pinamar', pos: 'center center' },
    ],
    Icon: FlagIcon,
    title: 'Karting',
  ...
  {
    images: [
      { src: '/img/svc/performance-motor-turbo.webp', alt: 'Motor turbo performance — ARP Pinamar', pos: 'center center' },
      { src: '/img/svc/performance-escape-quad.webp', alt: 'Escape deportivo performance — ARP', pos: 'center 40%' },
      { src: '/img/svc/mecanica-motor-modif.webp',    alt: 'Motor modificado — Andrés Racing Performance', pos: 'center center' },
    ],
    Icon: ZapIcon,
  ...
  {
    images: [
      { src: '/img/svc/alineacion-sensor-rueda.webp',    alt: 'Alineación computarizada — Andrés Racing Performance · Pinamar', pos: 'center center' },
      { src: '/img/svc/alineacion-tren-herramienta.webp',alt: 'Tren delantero alineación — ARP Pinamar', pos: 'center center' },
      { src: '/img/svc/frenos-disco-pinza.webp',         alt: 'Frenos y tren delantero — ARP', pos: 'center center' },
    ],
    Icon: AlignIcon,
  ...
  {
    images: [
      { src: '/img/svc/pista-escape-suspension.webp', alt: 'Preparación para pista — ARP Pinamar', pos: 'center center' },
      { src: '/img/performance-turbo.webp',            alt: 'Auto preparado pista — Andrés Racing Performance', pos: 'center center' },
    ],
    Icon: TargetIcon,
