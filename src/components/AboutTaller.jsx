...
const pillars = [
  'Diagnóstico antes de intervenir — nunca a ciegas',
  'Hablás directo con quien trabaja tu auto',
  'Cada trabajo se explica antes y después',
]
        ...
        <div className="about-grid">
          ...
          <div ref={leftRef} className="reveal">
            ...
            <p className="s-sub">
              ...
              vehículos modificados y proyectos de performance — con banco Dynojet disponible,
              diagnóstico electrónico y mecánica con criterio.
            </p>
            <p className="s-sub" style={{ marginTop: '12px' }}>
              Cada trabajo empieza por entender el auto. No por adivinar.
            </p>

            <ul className="about-pillars">
              {pillars.map((p, i) => (
                <li className="about-pillar" key={i} style={{ '--i': i }}>
                  <span className="about-pillar-check"><CheckIcon /></span>
                  {p}
                </li>
              ))}
            </ul>
            ...
            <blockquote className="about-quote">
              ...
              <footer>— Andrés Sperati, mecánico · Valeria del Mar</footer>
            </blockquote>

            <a className="btn btn-pink" href={WA_LINK} target="_blank" rel="noopener noreferrer"
               style={{ marginTop: '28px', display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
          ...
          <div ref={rightRef} className="reveal-r about-visual">
            {/* ⚠️ Reemplazar /img/atencion-cliente.png por una foto real de Andrés */}
            <div className="about-owner-photo">
              <img
                src="/img/atencion-cliente.png"
