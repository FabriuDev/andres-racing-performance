...
const MAIN_IMGS = [
  '/img/dyno-auto-banco.png',
  '/img/dyno-banco-curva.png',
  '/img/dyno-software-curva.png',
]

const SM1_IMGS = [
  '/img/karting/karting-motor-premium.png',
  '/img/mecanica-motor.png',
  '/img/karting/karting-revision.png',
  '/img/taller-mecanica-auto.png',
]
const SM1_LABELS = ['Karting', 'Motor', 'Karting', 'Taller']

const SM2_IMGS = [
  '/img/diagnostico-escaner.png',
  '/img/diagnostico-laptop.png',
  '/img/diagnostico-peugeot.png',
  '/img/diagnostico-tablet.png',
]
